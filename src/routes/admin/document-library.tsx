...
import { 
  Library, Search, Filter, FileText, 
  MoreVertical, Edit2, Eye, Download, 
  Plus, Tag, History, CheckCircle2,
...
function DocumentLibraryPage() {
  ...
  const { templates, isLoadingTemplates, categories, isLoadingCategories } = useDocuments();
