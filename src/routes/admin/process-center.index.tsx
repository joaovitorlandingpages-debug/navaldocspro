...
function ProcessCenterListPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div id="ts-visual-edit-probe-d64f8cdc8d784d2a" className="hidden whitespace-pre-wrap">Perfeito.

Não considere a homologação concluída ainda.

Continue a execução até o fim e entregue o relatório final completo contendo:

- Build (PASS/FAIL);
- Typecheck;
- Resultado detalhado do Playwright;
- Cenários executados;
- Cross-tenant (QA A × QA B);
- Red Team (P0/P1/P2/P3);
- Processo finalizado (imutabilidade);
- Testes de permissões;
- Performance (queries, N+1, bundle, invalidações, tempos);
- Evidências geradas;
- Limitações encontradas;
- Veredito final: PASS, PASS PARCIAL ou FAIL.

Somente após esse relatório encerraremos oficialmente o Enterprise Process Center e iniciaremos a próxima etapa do NavalDocs Pro.</div>
    </div>
  );
}
