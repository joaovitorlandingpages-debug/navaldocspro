  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-sm:h-[100dvh] max-sm:w-full max-sm:bottom-0 max-sm:top-0 max-sm:translate-y-0 max-sm:translate-x-[-50%] max-sm:rounded-none max-sm:p-0 max-sm:gap-0 max-sm:overflow-hidden flex flex-col",
        className,
      )}
      {...props}
    >
